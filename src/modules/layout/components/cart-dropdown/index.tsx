    ...
    >
      <Popover className="relative h-full">
        <Popover.Button className="h-full">
          ...
          >{cartIcon} <span className="absolute -top-2 left-1 bg-primaryColor text-white text-center font-semibold rounded-full text-[10px] pb-[1px]  flex items-center justify-center m-0 w-4
          h-4">
